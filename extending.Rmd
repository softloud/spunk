...
Thank you x and x for considering helping out with this project. The most important thing to check is that the code does what the manuscript says it does. 

Checking each target in the [`_targets`](https://books.ropensci.org/targets/) file filters to things expected and so forth. 
